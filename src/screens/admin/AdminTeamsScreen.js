...
const styles = StyleSheet.create({
  ...
  deptName:     { fontSize: 15, fontWeight: 'bold', color: '#1A237E' },
  addBtn:       { flexDirection: 'row', alignItems: 'center', gap: 4, backgroundColor: '#1A237E', borderRadius: 8, paddingVertical: 6, paddingHorizontal: 10 },
